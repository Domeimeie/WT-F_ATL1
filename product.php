...
<body>
  ...
  <main class="content">
    ...
    <div class="product">
      ...
      <div class="productDesc">
        ...
        <p>Bring a splash of color and a touch of nostalgia into your space with our delightful 2024 Dodo-Themed
          ...
          make you smile all year round. Perfect for animal lovers, nature enthusiasts, or anyone who enjoys a dash of
    ...
    <div class="product">
      <picture class="productImage">
        <img src="media/productImages/dodoPajama.webp" alt="Dodo Pajama">
      </picture>
      <div class="productDesc">
        <h2>Dodo Pajama</h2>
    ...
    <div class="product">
      <picture class="productImage">
        <img src="media/productImages/dodoPhoneCase.webp" alt="Dodo Phone Cases">
      </picture>
      <div class="productDesc">
    ...
    <div class="product">
      <picture class="productImage">
        <img src="media/productImages/dodobottle.webp" alt="Dodo Water bottle">
      </picture>
      <div class="productDesc">
